...
def get_Policy_Data(ID):
    ...
    if isinstance(ID, str):
        try:
            ...
            return f"The provided ID {ID} could not be parsed as a integer. Please provide an in Integer ID"
...
def get_Models_Prediction(ID):
    ...
    Args:    ID (int): ID of the policy to predict.
    Returns: str: A dictionary containing the predicted premiums and insights from both models."""
